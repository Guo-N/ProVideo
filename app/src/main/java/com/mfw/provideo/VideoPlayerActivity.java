...
import com.mfw.provideo.databinding.PlayerActivityVideoPlayerBinding;
 ...
 * @since 2020-02-20
 */
@Route(path = ActivityRouterInit.Video.PAGER_VIDEO)
public class VideoPlayerActivity extends
        BaseActivity<PlayerActivityVideoPlayerBinding, BaseVideoViewModel>
{
...
//        ScreenAutoAdapter.match(this, 375.0f);
        ...
        viewModel.loadNominate(this.getClass());
        viewModel.loadReplay(this.getClass());
