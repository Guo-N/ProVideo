...
import com.mfw.communitymodule.Service.BaseViewModel;
import com.mfw.communitymodule.Utils.GsonUtils;
import com.mfw.communitymodule.community.bean.AttentionCardBean;
...
public class AttentionViewModel<T> extends BaseViewModel {

    public static final String DEFAULT_URL = "https://baobab.kaiyanapp.com/api/v6/community/tab/follow";
